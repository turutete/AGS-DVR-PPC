	...
	'tests':	{
		...
		'modules':	{
			...
			'sepecserver':	{
				'name':		'sepecserver',
				'do_mod':	True,
				'slibs':	[ 'agssdscore', 'sdscoreglib', 'cmserveronly', 'cmmibinit', 'agsgw', 'gwsnmp', 'cmzigorbus', 'cmzigorobj', 'cmzigormng', ],
				'sources_fn':	[],
			...
			'sepecgtk2':		{
				...
				'do_mod':	True,
				'libs':		[ 'sepecclient' ],
				'slibs':	[ 'uigtk2', 'gtk2gladelo', 'gtk2pixbufs', 'gtk2treestore', 'gtk2treeview', 'gtk2keysnooper', 'gtk2line', ],
				'pc':		[ 'pkg-config --libs --cflags libglade-2.0' ],
				'sources_fn':	[],
			},
			'sepec':		{
...
all_data = {
	'config':	{
		...
		'data_fn':			[ 'functions.lua', 'parameter.lua', 'oids-zigor.lua', 'oids-parameter.lua',
						'mgetty_config.lua', 'net.lua', 'storetable.lua', 'treestore.lua', 'oids-alarm.lua',
						'oids-alarm-log.lua', 'edit.lua', 'gtk.lua', 'alarmtable.lua', 'alarmlogtable.lua',
						['sepec-snmpd.lua', 'config.lua','setup.lua','sepec-snmpd.lua'],
						'oids-sepec.lua', 'defs-sepec.lua', 'objs-sepec.lua', 'script-snmpd-sepec.lua',
						'active-sepec.lua', 'factory-sepec.lua', 'snmpd_conf-sepec.lua', 'alarms-sepec.lua',
						'alarmlog-sepec.lua',
						[ 'sepec-gtk2ui.lua', 'config.lua','setup.lua','sepec-gtk2ui.lua'],
						[ 'sepec-gtk2ui-local.lua', 'config.lua','setup.lua','sepec-gtk2ui-local.lua'],
						'script-gtk2ui-sepec.lua', 'config-edit-sepec.lua', 'displays-sepec.lua',
						'persist-data-sepec.lua', ],
	},
	'ui':	{
		'config_install_dir':	'/share/ui/',
		'data_fn':			[ 'ui-sepec-1.lxml', 'ui-sepec-2.lxml', 'ui-sepec-3.lxml', 'ui-sepec.glade', ],
	},
	'pixbufs':	{
		'config_install_dir':	'/share/pixbufs/',
		'data_fn':			[ 'redball.xpm', 'greenball.xpm', 'grayball.xpm', 'zigor_p.xpm', 'tree_sis.xpm', 'redbell.xpm', 'greenbell.xpm', 'orangebell.xpm', 'yellowbell.xpm', 'sinoptico-sepec.xpm', 'openedswitch.xpm', 'closedswitch.xpm', ],
	},
	'mibs':	{
		'config_install_dir':	'/share/mibs/',
		'data_fn':			[ 'ZIGOR-SMI.txt', 'ZIGOR-TC.txt', 'ZIGOR-PRODUCTS-MIB.txt', 'ZIGOR-SEPEC-MIB.txt', 'ZIGOR-PARAMETER-MIB.txt', 'ZIGOR-ALARM-MIB.txt', 'ZIGOR-ALARM-LOG-MIB.txt', 'ZIGOR-STATUS-MIB.txt' ],
	},
}
