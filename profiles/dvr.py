	...
	'cm':		{
		...
		'modules':	{
			...
			'cmmodbus':	{
				'name':		'cmmodbus',
				'do_sstatic':	True,
				'gobs_fn':	[ 'cm-modbus.gob' ],
				'sources_fn':	[ 'cm-modbus.c', 'mb.c', 'mbcrc.c', 'mbfunccoils.c', 'mbfuncdiag.c', 'mbfuncdisc.c', 'mbfuncholding.c', 'mbfuncinput.c', 'mbfuncother.c', 'mbrtu.c', 'mbutils.c', 'portevent.c', 'portother.c', 'portserial.c', 'porttimer.c', 'porttcp.c', 'mbtcp.c', 'mbascii.c', ],
				'pc':		[ 'pkg-config --libs --cflags gobject-2.0' ],
			},
		},
	},
...
all_data = {
	'config':	{
		...
		'data_fn':			[ 'functions.lua', 
						[ 'dvr-snmpd.lua',  'config.lua','setup.lua','dvr-snmpd.lua' ],
						'defs-dvr.lua', 'objs-dvr.lua', 'oids-zigor.lua', 'oids-dvr.lua',
						'oids-parameter.lua', 'script-gtk2ui-dvr.lua',
						[ 'dvr-gtk2ui.lua',  'config.lua','setup.lua','dvr-gtk2ui.lua' ],
						[ 'dvr-gtk2ui-local.lua',  'config.lua','setup.lua','dvr-gtk2ui-local.lua' ],
						'script-snmpd-dvr.lua', 'parameter.lua', 'active-dvr.lua',
						'factory-dvr.lua', 'snmpd_conf-dvr.lua', 'mgetty_config.lua', 'net.lua',
						[ 'dvr-curs2x16.lua', 'config.lua','setup.lua','dvr-curs2x16.lua' ],
						'script-curs2x16-dvr.lua', 'storetable.lua', 'treestore.lua',
						'oids-alarm.lua', 'oids-alarm-log.lua', 'edit.lua', 'alarmtable.lua',
	...
	'mibs':	{
		...
		'data_fn':			[ 'ZIGOR-SMI.txt', 'ZIGOR-TC.txt', 'ZIGOR-PRODUCTS-MIB.txt', 'ZIGOR-DVR-MIB.txt', 'ZIGOR-PARAMETER-MIB.txt', 'ZIGOR-ALARM-MIB.txt', 'ZIGOR-ALARM-LOG-MIB.txt', 'ZIGOR-STATUS-MIB.txt' ],
	},
}
