...
all_data = {
	'config':	{
		...
		'data_fn':			[ 'functions.lua',
						[ 'sunzet100-snmpd.lua', 'config.lua','setup.lua','sunzet100-snmpd.lua' ],
						'defs-sunzet.lua', 'objs-sunzet.lua', 'oids-zigor.lua', 'oids-sunzet.lua',
						'oids-parameter.lua', 'script-gtk2ui-sunzet100.lua',
						[ 'sunzet100-gtk2ui.lua', 'config.lua','setup.lua','sunzet100-gtk2ui.lua' ],
						'script-snmpd-sunzet100.lua', 'parameter.lua', 'active-sunzet.lua',
						'factory-sunzet100.lua', 'snmpd_conf-sunzet.lua', 'mgetty_config.lua', 'net.lua',
						[ 'sunzet100-curs2x16.lua', 'config.lua','setup.lua','sunzet100-curs2x16.lua' ],
						'script-curs2x16-sunzet100.lua', 'storetable.lua', 'treestore.lua', 'oids-alarm.lua',
						'oids-alarm-log.lua', 'edit.lua', 'alarmtable.lua', 'alarmlogtable.lua',
						'alarms-sunzet.lua', 'displays-sunzet100.lua', 'alarmlog-sunzet.lua', 'zonas-sunzet.lua',
	...
	'ui':	{
		...
		'data_fn':			[ 'ui-sunzet100-1.lxml', 'ui-sunzet100-2.lxml', 'ui-sunzet100-3.lxml', 'ui-sunzet100-4.lxml', 'ui-sunzet.glade', ],
	},
	'pixbufs':	{
