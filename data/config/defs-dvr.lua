...
--    Marcha              = { start = 56, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
      DeteccionEnable     = { start = 55, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    MarchaCon16         = { start = 54, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    ParoSeta            = { start = 53, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    debug1              = { start = 52, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
      ErrorTemp           = { start = 51, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    debug2              = { start = 50, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    debug3              = { start = 49, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
--    espera_arranque     = { start = 48, len =  1, cod = COD_UINT, type = G_TYPE_INT, maps = boolmap, },
   },
   VRed = {
