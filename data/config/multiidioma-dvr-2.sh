...
FILE=ui-$PROFILE-1024x600.glade
#FILE=ui-xxx.glade
...
echo ""
echo "Convertir a formato BINARIO (.mo) con:"
echo ">>> msgfmt en.po -o en.mo"
echo "y copiar a /usr/share/locale/en/LC_MESSAGES"
...
echo ""
echo "Actualizaciones de catalogos tras actualizacion de plantilla:"
echo ">>> msgmerge -o file def.po ref.pot"
echo "OJO mirar para que en cadenas nuevas no haga sugerencia de traduccion con #fuzzy"
echo ""
echo "Para pasar a traducir, mejor pasar en formato DOS:"
echo ">>> unix2dos -n xxx.pot xxx.pot.txt"
echo "----------"
