    ----------------------------------------------------------------------------------------------------------    
    -- Este codigo se ha obtenido de la web https://help.interfaceware.com/code/details/sha1-lua
    -- Tiene como objetivo principal llevar a cabo el guardado de las claves de usuario mediante un hash.
    -- Dato que Lua no contiene de forma nativa el hashing de cadenas de texto, se hace uso de este modulo.
    ----------------------------------------------------------------------------------------------------------
    --
    --
    -- $Revision: 1.5 $
