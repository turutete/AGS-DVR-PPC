...
#User nobody
#Group nogroup
#Para que los scripts puedan tener permisos: (y root no restart el boa!)
User ags
Group users
...
DocumentRoot /usr/local/zigor/activa/www/html
...
ScriptAlias /cgi-bin/ /usr/local/zigor/activa/www/cgi-bin/
